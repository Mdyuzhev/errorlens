<template>
  ...
  >
    ...
    <template v-else-if="name === 'folder-open'">
      <path d="M2 19V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v1" />
      <path d="M3.5 21h17.1a1 1 0 0 0 1-.8l1.9-9.2a1 1 0 0 0-1-1.2H5.4a1 1 0 0 0-1 .8L2 21" />
    </template>

    <!-- flask -->
    <template v-else-if="name === 'flask'">
      <path d="M9 3h6" />
      <path d="M10 3v7.4a2 2 0 0 1-.5 1.3L4 18.6a1 1 0 0 0 .8 1.4h14.4a1 1 0 0 0 .8-1.4l-5.5-6.9a2 2 0 0 1-.5-1.3V3" />
      <path d="M8.5 14h7" />
    </template>
    ...
    <template v-else-if="name === 'cpu'">
      <rect x="9" y="9" width="6" height="6" /><rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
